...
public class MapView implements MapChangeObserver {
    ...
    private List<String> wrapText(String message, FontMetrics fm, int maxWidth) {
        ...
        if (message.equals("End point must be placed on a road tile!")) {
            lines.add("End point must be");
            lines.add("placed on a road!");
        } else if (message.equals("Start point must be placed on a road tile!")) {
            lines.add("Start point must be");
            lines.add("placed on a road!");
        } else if (message.equals("Cannot save map: Both start and end points are missing!")) {
            lines.add("Cannot save map:");
            lines.add("Both start and end");
            lines.add("points are missing!");
        } else if (message.equals("Cannot save map: Start point is missing!")) {
            lines.add("Cannot save map:");
            lines.add("Start point is missing!");
        } else if (message.equals("Cannot save map: End point is missing!")) {
            lines.add("Cannot save map:");
            lines.add("End point is missing!");
        } else if (message.equals("Cannot save map: No valid path found between start and end points!")) {
            lines.add("Cannot save map:");
            lines.add("No valid path found");
            lines.add("between start and");
            lines.add("end points!");
        } else {
